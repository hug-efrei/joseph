...
func main() {
	...
	r.GET("/", func(c *gin.Context) {
		...
		for rows.Next() {
			...
			rows.Scan(&b.ID, &b.Title, &b.Author, &b.AuthorID, &b.Path, &seriesName, &seriesID, &seriesIndex)
	...
	r.GET("/book/:id", func(c *gin.Context) {
		...
		err := row.Scan(&b.ID, &b.Title, &b.Author, &b.AuthorID, &b.Path, &seriesName, &seriesID, &seriesIndex, &description)
		if err != nil {
